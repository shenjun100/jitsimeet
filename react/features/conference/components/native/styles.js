...
export default {
    ...
    roomTimerView: {
        ...
        //SJ: change timer view color to dark blue and add border radius
    ...
    roomNameView: {
        ...
        //SJ: change room name view color to transparent and add border radius
    ...
    roomNameWrapper: {
        alignItems: 'center',
        //flexDirection: 'row'
        //SJ: change room name and timer to column spacing and add margin top
